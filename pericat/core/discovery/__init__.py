"""
pericat/core/discovery/

Autodiscovery sources for Pericat.
...
"""
from pericat.core.discovery.config_detector import detect_all
...
from pericat.core.discovery.tool_discovery import (
    list_tools_for,
    list_tools_for_all,
)
