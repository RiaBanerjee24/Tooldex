"""
pericat/_cli_output.py

Formatting helpers for `pericat discover` CLI output.
...
from pericat.core.discovery.results import ConfigDetectionResult, ToolDiscoveryResult
