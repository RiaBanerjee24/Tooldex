            ...
            <Wrap>
                <div style={{ display: "flex", alignItems: "center", height: 56, gap: 8 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginRight: 36 }}>
                        <img src="/toolpool.svg" alt="Toolpool" width={26} height={26} style={{ flexShrink: 0 }} />
                        <div style={{ display: "flex", alignItems: "baseline", gap: 7 }}>
                            <span style={{ fontFamily: "Georgia, serif", fontWeight: 500, fontSize: 18, color: "var(--cream)", letterSpacing: "-0.01em" }}>Toolpool</span>
