"""
toolpool/core/parsers/loader.py
...
from toolpool.core.parsers.transformers import parse_agent, parse_server

logger = logging.getLogger("toolpool.loader")
...
def load_included_file(path: Path) -> Optional[FileContents]:
    ...
    root_only_keys = ("policy_engines", "metadata", "toolpool", "observatory")
