"""
toolpool/core/discovery/_readers.py
...
from toolpool.core.discovery._paths import claude_code_user_path
from toolpool.core.discovery.results import DiscoverySource, SourceStatus

logger = logging.getLogger("toolpool.discovery.readers")
