"""
toolpool/core/discovery/results.py

Data containers for discovery results.

A `DiscoverySource` records what happened when toolpool looked at one known
...
toolpool found, missed, or failed to parse.
...
class DiscoveredTool:
    ...
    Separate from toolpool.core.models.Tool, which carries
