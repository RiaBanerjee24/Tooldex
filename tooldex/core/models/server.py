...
class MCPServer(BaseModel):
    ...
    # Populated by autodiscovery (tooldex discover). Empty for YAML-only manifests.
    ...
    # "cursor_project", "docker_mcp:tooldex"). Set by config_detector._merge_servers.
    ...
    # Worst severity across all findings: HIGH / MEDIUM / LOW / INFO / None
