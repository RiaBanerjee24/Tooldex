"""
tooldex/core/discovery/results.py

Data containers for discovery results.

A `DiscoverySource` records what happened when tooldex looked at one known
...
tooldex found, missed, or failed to parse.
...
class DiscoveredTool:
    ...
    Separate from tooldex.core.models.Tool, which carries
